...
class UserWelcome extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('Algumas dicas para você aproveitar ao máximo nossos serviços:')
                    ...
                    ->line("Os serviços do Practice estão disponíveis a toda a comunidade acadêmica da UFFS. Tudo isso grátis, fácil e rápido.")
                    ->line("Até mais,")
